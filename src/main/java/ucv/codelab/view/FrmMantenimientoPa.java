...
public class FrmMantenimientoPa extends JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(41, 43, 45)),
                "MANTENIMIENTO PACIENTE", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, new Font("Dialog", 1, 36),
                new Color(0, 51, 102)));
        setPreferredSize(new Dimension(950, 714));
