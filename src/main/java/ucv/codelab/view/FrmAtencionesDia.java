...
public class FrmAtencionesDia extends PanelBase {
    ...
    private void initComponents() {
        ...
        addComponent(txtApellidoNombre, 0, 0, 1, 1, GridBagConstraints.HORIZONTAL, 319, 38, 1.0, 1.0);
        addComponent(txtFecha, 1, 0, 1, 1, GridBagConstraints.HORIZONTAL, 319, 38, 1.0, 1.0);
        addComponent(btnBuscar, 3, 0, 1, 1, GridBagConstraints.NONE, 32, 0, 0.0, 1.0);
